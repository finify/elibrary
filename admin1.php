...
<ul>
  ...
  <div class="dropdown-content">
      <a href="admin1.php">ALL EBOOKS</a>
  ...
  <div class="dropdown-content">
      <a href="adminvideo.php">ALL VIDEOS</a>
      <a href="#">ELECTRONICS</a>
      <a href="#">NETWORKING</a>
    </div>
  </li>
...
<div id="header" style="width:100%;height:25px;text-align:center; font-size:25px; background-color:teal; color:white;">Trending books
</div>
